...
parser.add_argument('-dd','--data_directory',required=True,help='Path to directory contaning the remaining molecules of the database ')
...
def molecular_file_count_updated(protein, n_it, data_directory, tot_process, tot_sampling):
    files = []
...
molecular_file_count_updated(protein, n_it, data_directory, tot_process, tot_sampling)
